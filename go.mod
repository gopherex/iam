...
require (
	...
	github.com/gopherex/xlog/contrib/libs/pgx v1.0.0
	github.com/gopherex/xprobe v1.0.0
	github.com/gopherex/xshutdown v1.0.0
	github.com/gopherex/xtrace/contrib/libs/xlog v1.0.0
	github.com/gopherex/xtrace/contrib/sdk v1.0.0
...
require (
	...
	github.com/gopherex/xlog/contrib/libs/otel v1.0.0 // indirect
