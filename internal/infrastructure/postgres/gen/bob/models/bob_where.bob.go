...
func Where[Q psql.Filterable]() struct {
	IamSecurityPolicies      iamSecurityPolicyWhere[Q]
	IamSecurityGuards        iamSecurityGuardWhere[Q]
	IamSecurityDevices       iamSecurityDeviceWhere[Q]
	IamSecurityIncidents     iamSecurityIncidentWhere[Q]
	IamSecurityContinuations iamSecurityContinuationWhere[Q]
	IamSecurityCases         iamSecurityCaseWhere[Q]
	IamSecurityDeliveries    iamSecurityDeliveryWhere[Q]
	IamSecurityAttempts      iamSecurityAttemptWhere[Q]
	IamSecurityCaseDecisions iamSecurityCaseDecisionWhere[Q]
	...
	IamAccountDeletions      iamAccountDeletionWhere[Q]
} {
	return struct {
		IamSecurityPolicies      iamSecurityPolicyWhere[Q]
		IamSecurityGuards        iamSecurityGuardWhere[Q]
		...
		IamSecurityPolicies:      buildIamSecurityPolicyWhere[Q](IamSecurityPolicies.Columns),
		IamSecurityGuards:        buildIamSecurityGuardWhere[Q](IamSecurityGuards.Columns),
		IamSecurityDevices:       buildIamSecurityDeviceWhere[Q](IamSecurityDevices.Columns),
		IamSecurityIncidents:     buildIamSecurityIncidentWhere[Q](IamSecurityIncidents.Columns),
		IamSecurityContinuations: buildIamSecurityContinuationWhere[Q](IamSecurityContinuations.Columns),
		IamSecurityCases:         buildIamSecurityCaseWhere[Q](IamSecurityCases.Columns),
		IamSecurityDeliveries:    buildIamSecurityDeliveryWhere[Q](IamSecurityDeliveries.Columns),
		IamSecurityAttempts:      buildIamSecurityAttemptWhere[Q](IamSecurityAttempts.Columns),
		IamSecurityCaseDecisions: buildIamSecurityCaseDecisionWhere[Q](IamSecurityCaseDecisions.Columns),
		...
		IamAccountDeletions:      buildIamAccountDeletionWhere[Q](IamAccountDeletions.Columns),
	}
}
